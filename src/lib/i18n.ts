...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.sModeD": { es: "Se elige en ajustes del grupo. Al marcar un pago, eliges qué gastos cubre (o se cubren solos) y los ves marcarse como pagados.", en: "Pick it in group settings. When you mark a payment, choose which expenses it covers (or they're covered automatically) and watch them get marked as paid." },
  ...
  "onboard.demo.simAfter": { es: "Cena y Vino ya están pagados. Postre sigue pendiente.", en: "Dinner and Wine are now paid. Dessert is still pending." },
