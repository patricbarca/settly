...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "login.usePasswordOn": { es: "Iniciar sesión con contraseña", en: "Sign in with password" },
  "login.usePasswordOff": { es: "Volver al login normal", en: "Back to normal login" },
  ...
  "onboard.s1d": { es: "La app con IA que hace que todos paguen lo que deben. Sin incomodidades, sin calculadoras, sin dramas.", en: "The AI-powered app that makes sure everyone pays what they owe. No awkwardness, no calculators, no drama." },
  ...
  "onboard.s3d": { es: "Haz una foto al recibo. La IA lee cada artículo, detecta la moneda si es distinta y arma el gasto. Ajusta quién consumió qué — y cualquiera con permiso puede editarlo después.", en: "Take a photo of the receipt. AI reads each item, detects the currency if it's different, and builds the expense. Adjust who had what — and anyone with permission can edit it later." },
  ...
  "onboard.sModeD": { es: "Directo hace que cada quien le pague a quien puso el dinero real, aunque eso sean varios pagos en cadena. Simplificado detecta esas cadenas y las junta en una sola transacción por transitividad. Se elige en ajustes del grupo.", en: "Direct has everyone pay whoever actually fronted the money, even if that's a chain of several payments. Simplified spots those chains and nets them into a single transfer by transitivity. Pick it in group settings." },
  "onboard.demo.oneTransfer": { es: "1 transferencia en total", en: "1 transfer total" },
  "onboard.demo.twoTransfers": { es: "2 transferencias — una por gasto real", en: "2 transfers — one per real expense" },
  "onboard.s5t": { es: "Salda tus cuentas", en: "Settle up" },
  "onboard.s5d": { es: "En modo Directo eliges qué gastos cubre cada pago y los ves pasar de Pendiente a Pagado. En modo Simplificado pagas directamente el monto neto que le debes a cada persona.", en: "In Direct mode you choose which expenses a payment covers and watch them go from Pending to Paid. In Simplified mode you just pay the net amount you owe each person." },
  "onboard.demo.nowPaid": { es: "Ahora aparecen como Pagados en el listado", en: "Now they show as Paid in the expense list" },
  "onboard.demo.directMode": { es: "Modo Directo", en: "Direct mode" },
  "onboard.demo.totalOwed": { es: "Total pendiente", en: "Total pending" },
  ...
  "onboard.demo.newGroup": { es: "Grupo nuevo", en: "New group" },
  "onboard.demo.groupName": { es: "Cena de cumpleaños", en: "Birthday Dinner" },
  "onboard.demo.groupNamePlaceholder": { es: "Viaje, piso, cena...", en: "Trip, flat, dinner..." },
  ...
  "onboard.demo.fxTitle": { es: "Moneda detectada: euros", en: "Currency detected: euros" },
  "onboard.demo.fxRate": { es: "Convertido a dólares · tasa del día (Pro)", en: "Converted to dollars · today's rate (Pro)" },
  ...
  "onboard.demo.voiceSplit":{ es: "Dividido entre 3", en: "Split 3 ways" },
  "onboard.demo.billWifi": { es: "Wifi", en: "Wifi" },
  "onboard.demo.billWater":{ es: "Agua", en: "Water" },
  "onboard.demo.billElec": { es: "Electricidad", en: "Electricity" },
  ...
  "home.tabGroups": { es: "Grupos", en: "Groups" },
  "home.tabContacts": { es: "Contactos", en: "Contacts" },
  "nav.groups": { es: "Grupos", en: "Groups" },
  "nav.friends": { es: "Amigos", en: "Friends" },
  "nav.activity": { es: "Actividad", en: "Activity" },
  "nav.profile": { es: "Perfil", en: "Profile" },
  "contacts.title": { es: "Contactos", en: "Contacts" },
  "contacts.searchPh": { es: "Buscar por nombre o email…", en: "Search by name or email…" },
  "contacts.loading": { es: "Cargando contactos…", en: "Loading contacts…" },
  "contacts.empty": { es: "Aún no tienes contactos. Aparecerán las personas con las que compartas un grupo.", en: "No contacts yet. People you share a group with will show up here." },
  "contacts.none": { es: "Ningún contacto coincide con la búsqueda.", en: "No contacts match your search." },
  "contacts.remove": { es: "Ocultar contacto", en: "Hide contact" },
  "contacts.hidden": { es: "Ocultos", en: "Hidden" },
  "contacts.restore": { es: "Restaurar", en: "Restore" },
  "contacts.invite": { es: "Invitar amigos", en: "Invite friends" },
  // Saldos por amigo + settle general entre grupos (Pro)
  "friends.balances": { es: "Saldos con amigos", en: "Balances with friends" },
  "friends.youOwe": { es: "Le debes {amt}", en: "You owe {amt}" },
  "friends.theyOwe": { es: "Te debe {amt}", en: "Owes you {amt}" },
  ...
  "pay.confirm": { es: "Confirmar", en: "Confirm" },
  "friends.proTitle": { es: "Saldos y pagos entre grupos", en: "Cross-group balances & payments" },
  "friends.proUpsell": { es: "Ve lo que debes a cada amigo y salda todos los grupos de una vez (Pro).", en: "See what you owe each friend and settle all groups at once (Pro)." },
  "friends.settleTitle": { es: "Saldar con {name}", en: "Settle with {name}" },
  "friends.settleDesc": { es: "Elige qué gastos pagar de cada grupo. Se registra un pago en cada grupo; tú haces una sola transferencia por el total.", en: "Pick which expenses to pay from each group. A payment is logged in each group; you make one transfer for the total." },
  "friends.nothingToSettle": { es: "No le debes nada a {name} ahora mismo.", en: "You don't owe {name} anything right now." },
  "friends.convertTo": { es: "Convertir a", en: "Convert to" },
  "friends.perCurrency": { es: "Por moneda", en: "Per currency" },
  "friends.total": { es: "Total", en: "Total" },
  "friends.convertNote": { es: "Convertido a la tasa del día. Cada grupo se salda en su moneda.", en: "Converted at today's rate. Each group is settled in its own currency." },
  "friends.markAllPaid": { es: "Ya pagué el total", en: "I paid the total" },
  ...
  "hero.modeInfoSimplified": {
    es: "Este grupo usa el modo Simplificado: se calcula el mínimo número de transferencias para saldar cuentas, aunque a veces le pagues a alguien con quien no compartiste ningún gasto directamente. Al marcar un pago solo indicas el monto neto que le debes a esa persona (los gastos individuales no se marcan aquí; su estado vive en los saldos).",
    en: "This group uses Simplified mode: it computes the fewest transfers to settle up, even if that means paying someone you never actually shared an expense with. When you mark a payment you just enter the net amount you owe that person (individual expenses aren't marked here; their status lives in the balances).",
  },
  "hero.modeInfoDirect": {
  ...
  "members.manualHint": { es: "No necesitan tener Settlia instalado. Separa varios nombres con coma.", en: "They don't need to have Settlia installed. Separate multiple names with a comma." },
  "members.backSearch": { es: "← Buscar por email/teléfono", en: "← Search by email/phone" },
  "members.unclaimed": { es: "Sin cuenta", en: "No account yet" },
  ...
  "cat.prestamos": { es: "Préstamos", en: "Loans" },
  ...
  "explain.button": { es: "Explicar este saldo", en: "Explain this balance" },
  "explain.title": { es: "Desglose de {name}", en: "{name}'s breakdown" },
  "explain.share": { es: "Parte de los gastos", en: "Share of expenses" },
  "explain.shareTotal": { es: "Tu parte total", en: "Total share" },
  "explain.shareOwed": { es: "Tu parte de los gastos", en: "Share of expenses" },
  "explain.splitAmong": { es: "entre {n}", en: "split among {n}" },
  "explain.fronted": { es: "Pagaste por el grupo", en: "Paid for the group" },
  "explain.help.title": { es: "¿Qué significa cada línea?", en: "What does each line mean?" },
  "explain.help.share": { es: "Parte de los gastos: tu porción de cada gasto compartido.", en: "Share of expenses: your portion of each shared expense." },
  "explain.help.fronted": { es: "Pagaste por el grupo: dinero que pusiste tú en un gasto y que los demás te devuelven.", en: "Paid for the group: money you fronted on an expense that the others pay back to you." },
  "explain.help.made": { es: "Pagos que hizo: liquidaciones que hiciste para saldar lo que debías.", en: "Payments made: settle-up payments you made to clear what you owed." },
  "explain.help.received": { es: "Pagos que le hicieron: liquidaciones que te pagaron a ti.", en: "Payments received: settle-up payments others made to you." },
  "explain.help.result": { es: "Resultado: lo que te queda por pagar, o lo que te deben.", en: "Result: what you still owe, or what you're owed." },
  "explain.paymentsMade": { es: "Pagos que hizo", en: "Payments made" },
  "explain.paymentsReceived": { es: "Pagos que le hicieron", en: "Payments received" },
  "explain.owesResult": { es: "Le queda por pagar", en: "Still owes" },
  "explain.owedResult": { es: "Le deben", en: "Is owed" },
  "explain.settledResult": { es: "Estado", en: "Status" },
  "explainTr.title": { es: "¿Por qué este pago?", en: "Why this payment?" },
  "explainTr.simplifiedNote": { es: "En modo Simplificado agrupamos las deudas para minimizar el número de transferencias.", en: "In Simplified mode we group debts to minimize the number of transfers." },
  "explainTr.netFrom": { es: "{name} debe en total", en: "{name} owes in total" },
  "explainTr.netTo": { es: "A {name} le deben", en: "{name} is owed" },
  "explainTr.canChange": { es: "Este destinatario puede cambiar cuando otra persona pague.", en: "This recipient can change when someone else pays." },
  "explainTr.directHint": { es: "En modo Directo (Ajustes del grupo) cada quien le paga a quien fronteó cada gasto, y un pago no reordena a los demás.", en: "In Direct mode (group settings) everyone pays whoever fronted each expense, and one payment doesn't reshuffle the others." },
  "explainTr.directTitle": { es: "Este pago cubre estos gastos", en: "This payment covers these expenses" },
  "explainTr.seeMember": { es: "Ver desglose de {name}", en: "See {name}'s breakdown" },
  "explainTr.lumpNote": { es: "Los pagos se hicieron por montos sueltos (no atados a un gasto concreto), por eso aquí se muestra el saldo restante en vez de gastos.", en: "Payments were made as lump sums (not tied to a specific expense), so the remaining balance is shown here instead of expenses." },
  "explainTr.share": { es: "Parte de {name} en estos gastos", en: "{name}'s share of these expenses" },
  "explainTr.paidAlready": { es: "Ya pagado", en: "Already paid" },
  "explainTr.remaining": { es: "Queda por saldar", en: "Left to settle" },
  ...
  "exp.reviewBy": { es: "Revisión pedida por {name}", en: "Review requested by {name}" },
  "exp.paid": { es: "Pagado", en: "Paid" },
  ...
  "filter.searchPh": { es: "Buscar gasto…", en: "Search expense…" },
  ...
  "filter.none": { es: "Ningún gasto coincide con los filtros.", en: "No expenses match the filters." },
  "filter.count": { es: "{n} de {total}", en: "{n} of {total}" },
  ...
  "scan.byItems": { es: "Por ítems", en: "By items" },
  "scan.byTotal": { es: "Solo total", en: "Just total" },
  "scan.totalAmount": { es: "Monto total", en: "Total amount" },
  "scan.splitAmong": { es: "Entre quiénes se reparte", en: "Split among" },
  ...
  "scan.discountAuto": { es: "Descuento", en: "Discount" },
  ...
  "scan.tipNote": { es: "La propina se reparte en partes iguales entre quienes consumieron.", en: "The tip is split equally among those who consumed." },
  ...
  "scan.splitQty": { es: "Partir en {n} ítems", en: "Split into {n} items" },
  ...
  "aiConsent.what": { es: "Qué se envía: la foto del recibo, el audio de tu voz o el texto del gasto que introduces (solo cuando usas esas funciones).", en: "What is sent: the receipt photo, your voice audio, or the expense text you enter (only when you use those features)." },
  "aiConsent.who": { es: "A quién: nuestro proveedor de IA (Groq para escaneo, voz y texto). No se usa para entrenar modelos ni se guarda tras procesarlo.", en: "Who it goes to: our AI provider (Groq for scan, voice and text). It is not used to train models and is not stored after processing." },
  "aiConsent.purpose": { es: "Para qué: solo para convertir tu recibo/voz/texto en un gasto estructurado.", en: "Purpose: only to turn your receipt/voice/text into a structured expense." },
  "aiConsent.privacy": { es: "Más detalles en nuestra Política de Privacidad. Puedes usar la app sin IA y añadir los gastos a mano.", en: "More details in our Privacy Policy. You can use the app without AI and add expenses manually." },
  "aiConsent.accept": { es: "Aceptar y continuar", en: "Accept & continue" },
  "aiConsent.decline": { es: "Ahora no", en: "Not now" },
  ...
  "scan.fxConvertedShort": { es: "Convertido de {code} ({rate})", en: "Converted from {code} ({rate})" },
  ...
  "pay.theyPaidMe": { es: "{who} me pagó", en: "{who} paid me" },
  "pay.markDescReceipt": { es: "Registra que {who} te pagó {amt}. Quedará confirmado en el historial.", en: "Record that {who} paid you {amt}. It'll be confirmed in the history." },
  "pay.alsoPaidMe": { es: "¿Alguien más te pagó?", en: "Did anyone else pay you?" },
  ...
  "pay.coveredBy": { es: "cubierto por {name}", en: "covered by {name}" },
  ...
  "pay.cancelPayment": { es: "Cancelar pago", en: "Cancel payment" },
  "pay.cancelTitle": { es: "¿Cancelar este pago?", en: "Cancel this payment?" },
  "pay.cancelMsg": { es: "Se eliminará del historial ({from} → {to} · {amt}) y la deuda volverá a aparecer. No se puede deshacer.", en: "It will be removed from the history ({from} → {to} · {amt}) and the debt will reappear. This can't be undone." },
  "pay.paidAwaitingTitle": { es: "Pagado · esperando confirmación", en: "Paid · awaiting confirmation" },
  "pay.youPaidAwaiting": { es: "Pagaste {amt} a {to}", en: "You paid {amt} to {to}" },
  "pay.youPaidForAwaiting": { es: "Pagaste {amt} por {who} a {to}", en: "You paid {amt} for {who} to {to}" },
  "pay.undoPaid": { es: "Deshacer", en: "Undo" },
  ...
  "pay.logTitle": { es: "Historial de pagos", en: "Payment log" },
  ...
  "pay.matchesPaid": { es: "Coincide con lo pagado ({amt})", en: "Matches what was paid ({amt})" },
  "pay.overPaid": { es: "Te pasas por {amt} de lo pagado", en: "That's {amt} more than what was paid" },
  "pay.underPaid": { es: "Faltan {amt} para llegar a lo pagado", en: "That's {amt} short of what was paid" },
  ...
  "pay.copyAll": { es: "Copiar todo para pagar", en: "Copy all to pay" },
  "report.receipts": { es: "Recibos", en: "Receipts" },
  ...
  "notif.payment_rejected": { es: "{name} rechazó tu pago de {amt} — la deuda sigue pendiente", en: "{name} rejected your {amt} payment — the debt is still open" },
  "notif.review_requested": { es: "{name} pidió revisar «{label}»", en: "{name} requested a review of “{label}”" },
  ...
  "activity.payment_rejected": { es: "{name} rechazó un pago de {amt}", en: "{name} rejected a {amt} payment" },
  ...
  "activity.recurring_deleted": { es: "{name} borró el gasto recurrente «{label}»", en: "{name} deleted the recurring expense “{label}”" },
  ...
  "account.notifTypes": { es: "Qué notificaciones recibir", en: "Which notifications to receive" },
  "account.notifTypesHint": { es: "Aplica al centro de avisos y a los push.", en: "Applies to the notification center and to push." },
  "account.notifCat.expenses": { es: "Gastos nuevos", en: "New expenses" },
  "account.notifCat.payments": { es: "Pagos", en: "Payments" },
  "account.notifCat.requests": { es: "Solicitudes (revisión, borrado)", en: "Requests (review, deletion)" },
  "account.notifCat.reminders": { es: "Recordatorios diarios", en: "Daily reminders" },
  ...
  "settings.secondaryCurrency": { es: "Segunda moneda (Pro)", en: "Second currency (Pro)" },
  "settings.secondaryCurrencyHint": { es: "Ve todos los montos del grupo también en otra moneda, con la tasa del día.", en: "See all the group's amounts in another currency too, at the day's rate." },
  "settings.secondaryCurrencyNone": { es: "Ninguna", en: "None" },
  ...
  "faq.entry":    { es: "Preguntas frecuentes", en: "Help & FAQ" },
  "faq.entrySub": { es: "Cómo funciona cada parte de la app", en: "How each part of the app works" },
  "faq.title":    { es: "Preguntas frecuentes", en: "Help & FAQ" },
  "faq.cat.groups":   { es: "Grupos y miembros", en: "Groups & members" },
  "faq.cat.expenses": { es: "Gastos", en: "Expenses" },
  "faq.cat.balances": { es: "Balances y pagos", en: "Balances & payments" },
  "faq.cat.other":    { es: "Recurrentes, reportes y Pro", en: "Recurring, reports & Pro" },
  "faq.q.addMember": { es: "¿Cómo agrego a alguien a un grupo?", en: "How do I add someone to a group?" },
  "faq.a.addMember": {
    es: "Puedes elegirlos de tu red de contactos (personas con las que ya compartes un grupo) o agregarlos solo por nombre sin cuenta (\"añadir sin cuenta\"). Comparte el enlace de invitación del grupo y esa persona podrá reclamar su lugar cuando se una.",
    en: "Pick them from your contacts (people you already share a group with), or add them by name only, no account needed (\"add without an account\"). Share the group's invite link and they can claim their spot when they join.",
  },
  "faq.q.claim": { es: "¿Qué pasa cuando alguien se une con el enlace del grupo?", en: "What happens when someone joins via the group link?" },
  "faq.a.claim": {
    es: "Si el grupo tiene miembros agregados solo por nombre (sin cuenta), la persona que entra por el enlace puede elegir cuál de esos placeholders es ella misma — así hereda sus gastos ya cargados en vez de crear un miembro nuevo.",
    en: "If the group has members added by name only (no account), whoever joins via the link can pick which of those placeholders is them — so they inherit the expenses already logged instead of creating a brand-new member.",
  },
  "faq.q.addExpense": { es: "¿Cómo agrego un gasto?", en: "How do I add an expense?" },
  "faq.a.addExpense": {
    es: "Escríbelo en lenguaje natural (\"20 en pizza, pagó Ana\"), dictalo por voz, o escanea el ticket con la cámara. La app detecta monto, categoría y quién pagó; puedes ajustar todo antes de guardar.",
    en: "Type it in plain language (\"$20 pizza, paid by Ana\"), dictate it, or scan the receipt with your camera. The app detects the amount, category and payer; you can adjust everything before saving.",
  },
  "faq.q.split": { es: "¿Cómo se reparte un gasto entre los participantes?", en: "How is an expense split among participants?" },
  "faq.a.split": {
    es: "Por defecto se divide en partes iguales entre quienes participan. Puedes elegir montos exactos, porcentajes o partes por persona, y marcar más de un pagador si varios pusieron dinero.",
    en: "By default it's split equally among participants. You can set exact amounts, percentages or shares per person, and mark more than one payer if several people chipped in.",
  },
  "faq.q.scan": { es: "¿Cómo funciona escanear un recibo?", en: "How does receipt scanning work?" },
  "faq.a.scan": {
    es: "La IA lee el ticket y separa cada ítem con su precio, más propinas e impuestos. Puedes asignar cada plato a quien lo consumió (útil cuando alguien pidió 2 de algo) en vez de dividir todo por igual.",
    en: "The AI reads the receipt and lists each item with its price, plus tips and tax. You can assign each item to whoever consumed it (handy when someone ordered 2 of something) instead of splitting everything equally.",
  },
  "faq.q.modes": { es: "¿Qué diferencia hay entre modo Simplificado y Directo?", en: "What's the difference between Simplified and Direct mode?" },
  "faq.a.modes": {
    es: "Simplificado calcula el mínimo número de transferencias para saldar cuentas, aunque a veces le pagues a alguien con quien no compartiste ningún gasto directamente. Directo hace que cada quien le pague exactamente a quien puso el dinero de cada gasto — más pagos, pero cada uno corresponde a un gasto real. Se cambia en los ajustes del grupo.",
    en: "Simplified computes the fewest transfers to settle up, even if that means paying someone you never actually shared an expense with. Direct means everyone pays exactly whoever fronted each expense — more payments, but each one maps to a real expense. Toggle it in group settings.",
  },
  ...
  "faq.a.log": {
    es: "Al final de la pestaña Balances hay un registro con todos los pagos confirmados, con fecha y qué gastos cubre cada uno. Puedes filtrarlo por persona.",
    en: "At the bottom of the Balances tab there's a log of every confirmed payment, with its date and which expenses it covers. You can filter it by person.",
  },
  "faq.q.recurring": { es: "¿Cómo funcionan los gastos recurrentes?", en: "How do recurring expenses work?" },
  "faq.a.recurring": {
    es: "Configura un gasto que se repite (diario, semanal, mensual o anual) y la app genera automáticamente una nueva instancia cada vez que corresponde, la próxima vez que abras el grupo. Es una función Pro.",
    en: "Set up an expense that repeats (daily, weekly, monthly or yearly) and the app automatically generates a new instance each time it's due, the next time you open the group. This is a Pro feature.",
  },
  "faq.q.reports": { es: "¿Puedo exportar un reporte del grupo?", en: "Can I export a report for the group?" },
  "faq.a.reports": {
    es: "Sí (Pro): desde el ícono de documento en la cabecera del grupo puedes filtrar por mes y descargar un PDF o CSV con totales, saldos, liquidación y detalle de gastos.",
    en: "Yes (Pro): from the document icon in the group header you can filter by month and download a PDF or CSV with totals, balances, settle-up and expense detail.",
  },
  "faq.q.pro": { es: "¿Qué incluye Settlia Pro?", en: "What's included in Settlia Pro?" },
  "faq.a.pro": {
  ...
  // Reportes (Pro)
  "report.title": { es: "Reporte", en: "Report" },
  "report.proReason": { es: "Los reportes exportables son una función Pro.", en: "Exportable reports are a Pro feature." },
  "report.allTime": { es: "Todo el histórico", en: "All time" },
  "report.members": { es: "miembros", en: "members" },
  "report.summary": { es: "Resumen", en: "Summary" },
  "report.total": { es: "Gasto total", en: "Total spent" },
  "report.count": { es: "Nº de gastos", en: "Expenses" },
  "report.avg": { es: "Promedio", en: "Average" },
  "report.balances": { es: "Saldos por persona", en: "Balances per person" },
  "report.paidLabel": { es: "puso {amt}", en: "paid {amt}" },
  "report.settled": { es: "Al día", en: "Settled" },
  "report.settlement": { es: "Liquidación", en: "Settlement" },
  "report.allSettled": { es: "Todo saldado 🎉", en: "All settled 🎉" },
  "report.expenses": { es: "Detalle de gastos", en: "Expense detail" },
  "report.payments": { es: "Pagos realizados", en: "Payments made" },
  "report.empty": { es: "No hay gastos en este periodo.", en: "No expenses in this period." },
  ...
  "report.col.payer": { es: "Pagó", en: "Paid by" },
  "report.col.amount": { es: "Importe", en: "Amount" },
  "report.col.participants": { es: "Participantes", en: "Participants" },
  "report.col.member": { es: "Miembro", en: "Member" },
  "report.col.paid": { es: "Puso", en: "Paid" },
  "report.col.balance": { es: "Saldo", en: "Balance" },
  "report.col.from": { es: "De", en: "From" },
  "report.col.to": { es: "A", en: "To" },
  ...
  "paywall.billedAnnually":  { es: "$59.99 USD facturado anualmente", en: "$59.99 USD billed annually" },
  "paywall.billedMonthly":   { es: "$6.99 USD facturado mensualmente", en: "$6.99 USD billed monthly" },
  "paywall.pricesIn":        { es: "Precios en {cur}", en: "Prices in {cur}" },
  "paywall.billedYearlyG":   { es: "facturado por año", en: "billed yearly" },
  "paywall.billedMonthlyG":  { es: "facturado por mes", en: "billed monthly" },
  "paywall.trialAfter":      { es: "{trial} gratis · luego {price}/{per}", en: "{trial} free · then {price}/{per}" },
  "paywall.unit.day":        { es: "día", en: "day" },
  "paywall.unit.day_plural": { es: "días", en: "days" },
  "paywall.unit.week":       { es: "semana", en: "week" },
  "paywall.unit.week_plural":{ es: "semanas", en: "weeks" },
  "paywall.unit.month":      { es: "mes", en: "month" },
  "paywall.unit.month_plural":{ es: "meses", en: "months" },
  "paywall.unit.year":       { es: "año", en: "year" },
  "paywall.unit.year_plural":{ es: "años", en: "years" },
  ...
  "paywall.priceNote":       { es: "Pro: $6.99/mes · $59.99/año", en: "Pro: $6.99/mo · $59.99/year" },
