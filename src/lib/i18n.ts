...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.sModeD": { es: "Con los mismos 3 gastos, Simplificado junta todo en la mínima cantidad de pagos; Directo hace que cada quien le pague a quien puso el dinero real. Se elige en ajustes del grupo.", en: "With the same 3 expenses, Simplified nets everything into the fewest payments; Direct has everyone pay whoever actually fronted the money. Pick it in group settings." },
  ...
  "onboard.demo.houseExpenses": { es: "Gastos de la casa este mes", en: "This month's house expenses" },
  "onboard.demo.houseSplitEqual": { es: "Se reparten en partes iguales entre los 3.", en: "Split equally between the 3 of them." },
