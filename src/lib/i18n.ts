...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.s5d": { es: "Directo: eliges qué gastos cubre el pago y los ves pasar de Pendiente a Pagado. Simplificado: se cubren solos, del más antiguo al más nuevo, y el total pendiente baja.", en: "Direct: choose which expenses a payment covers and watch them go from Pending to Paid. Simplified: they're covered automatically, oldest to newest, and the amount owed goes down." },
  ...
  "onboard.demo.simPaying": { es: "Al pagar $18, se cubren los más antiguos primero.", en: "Paying $18 covers the oldest ones first." },
