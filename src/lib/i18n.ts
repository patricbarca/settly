...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "pay.markTitle": { es: "Confirmar pago recibido", en: "Confirm payment received" },
  "pay.markDesc": { es: "{from} te pagó {amt}. Confírmalo para saldar.", en: "{from} paid you {amt}. Confirm to settle." },
  "pay.attach": { es: "Adjuntar comprobante (opcional)", en: "Attach proof (optional)" },
  "pay.confirmPay": { es: "Confirmar", en: "Confirm" },
