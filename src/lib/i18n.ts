...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.demo.simBefore": { es: "3 gastos pendientes de Patrick con el grupo.", en: "3 pending expenses from Patrick." },
  "onboard.demo.simPaying": { es: "Pagas directamente el monto neto que le debes a esa persona.", en: "You just pay the net amount you owe that person." },
  "onboard.demo.simAfter": { es: "Wifi y Agua ya están pagados. Electricidad sigue pendiente.", en: "Wifi and Water are now paid. Electricity is still pending." },
