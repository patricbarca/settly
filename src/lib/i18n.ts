...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "loan.lent": { es: "Prestado", en: "Lent" },
  "loan.repaid": { es: "Devuelto", en: "Repaid" },
  "loan.outstanding": { es: "Pendiente", en: "Outstanding" },
  "loan.payment": { es: "Abono", en: "Payment" },
  "loan.undo": { es: "Deshacer", en: "Undo" },
  "loan.amountPh": { es: "Importe del abono", en: "Repayment amount" },
  "loan.addPayment": { es: "Registrar", en: "Add" },
  "loan.settled": { es: "Préstamo saldado", en: "Loan settled" },
