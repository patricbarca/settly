...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.s5d": { es: "En ambos modos eliges qué gastos cubre cada pago y los ves pasar de Pendiente a Pagado. En Simplificado los más antiguos vienen preseleccionados, pero puedes ajustar la selección.", en: "In both modes you choose which expenses a payment covers and watch them go from Pending to Paid. In Simplified the oldest ones come pre-selected, but you can adjust the selection." },
  ...
  "onboard.demo.simPaying": { es: "Eliges qué gastos cubre el pago — los más antiguos vienen marcados.", en: "You pick which expenses the payment covers — the oldest come pre-checked." },
