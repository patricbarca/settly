...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.sModeD": { es: "Simplificado calcula el mínimo de pagos para saldar cuentas. Directo hace que cada quien le pague a quien puso el dinero real. Se elige en los ajustes del grupo.", en: "Simplified computes the fewest payments to settle up. Direct has everyone pay whoever actually fronted the money. Pick it in group settings." },
