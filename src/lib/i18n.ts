...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.s5d": { es: "Pulsa \"Pagar\": en Directo eliges qué gastos cubre; en Simplificado se cubren solos. \"Método de pago\" te muestra cómo cobra la otra persona.", en: "Tap \"Pay\": in Direct mode you choose which expenses it covers; in Simplified they're covered automatically. \"Payment method\" shows you how the other person gets paid." },
