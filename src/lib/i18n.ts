...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.s4d": { es: "«Cena con Ana y Pedro, pagué 90». Settly lo entiende, crea el gasto y lo reparte. Sin tocar nada.", en: "«Dinner with Ana and Pedro, I paid 90». Settly understands, creates the expense, and splits it. Hands-free." },
