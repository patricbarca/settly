...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "pay.markDesc": { es: "Confirmas que pagaste {amt} a {to}. Quedará pendiente de su confirmación.", en: "You're marking {amt} as paid to {to}. It'll await their confirmation." },
