...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  "onboard.sTypeD": { es: "Escribe «café 12 con Ana» y pulsa Agregar: la IA crea el gasto, elige categoría y lo reparte. ¿Lo prefieres a mano? También puedes.", en: "Type «coffee 12 with Ana» and hit Add: AI creates the expense, picks a category and splits it. Prefer to do it by hand? You can too." },
  "onboard.demo.typeText": { es: "café con Ana 12", en: "coffee with Ana 12" },
