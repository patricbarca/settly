      ...
      <div className="max-w-2xl mx-auto w-full px-4 pt-5 flex-1 flex flex-col min-h-0">
        ...
        <div className="mb-5">
          ...
          <div className="glass rounded-xl p-3 mt-1 flex items-center justify-between gap-2">
            ...
            {plan === "free" ? (
              // Con IAP (RevenueCat) el CTA de compra SÍ se muestra en nativo
              // (guideline 3.1.1 se cumple vendiendo por In-App Purchase). En web
              // el mismo botón abre el paywall con Stripe.
              <button
